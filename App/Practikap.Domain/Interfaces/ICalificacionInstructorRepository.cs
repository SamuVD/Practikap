...
/// <summary>
/// Contrato de acceso a <see cref="CalificacionInstructor"/>. Modulo M5, direccion
/// Instructor hacia Aprendiz.
/// </summary>
/// <remarks>
...
public interface ICalificacionInstructorRepository
{
    ...
    Task<CalificacionInstructor?> ObtenerPorIdAsync(int id, CancellationToken ct);
    ...
    Task<IReadOnlyList<CalificacionInstructor>> ListarPorPracticaAsync(int practicaId, CancellationToken ct);
