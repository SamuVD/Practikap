...
public class PracticaConfiguration : IEntityTypeConfiguration<Practica>
{
       ...
       public void Configure(EntityTypeBuilder<Practica> builder)
       {
              ...
              builder.Property(p => p.Modalidad)
                     ...
                     // FA-11: centinela explicito. Ver la nota de UsuarioConfiguration.
                     .HasSentinel(default(Domain.Enums.ModalidadPractica))
                     .IsRequired();
              ...
              builder.Property(p => p.Estado)
                     ...
                     // FA-11: centinela explicito. Ver la nota de UsuarioConfiguration.
                     .HasSentinel(default(Domain.Enums.EstadoPractica))
                     .IsRequired();
