...
public class UsuarioConfiguration : IEntityTypeConfiguration<Usuario>
{
       ...
       public void Configure(EntityTypeBuilder<Usuario> builder)
       {
              ...
              builder.Property(u => u.Estado)
                     ...
                     // FA-11: el centinela ya era este de forma implicita. Declararlo
                     // explicito silencia el aviso EF Core 20601 y deja constancia de que
                     // 0 no es miembro de EstadoUsuario, asi que no puede confundirse con
                     // un valor legitimo. No altera el modelo ni genera migracion.
                     .HasSentinel(default(Practikap.Domain.Enums.EstadoUsuario))
                     .IsRequired();
