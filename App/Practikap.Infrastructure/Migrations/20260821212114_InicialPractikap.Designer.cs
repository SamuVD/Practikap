...
namespace Practikap.Infrastructure.Migrations
{
    ...
    [Migration("20260821212114_InicialPractikap")]
    partial class InicialPractikap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Practikap.Domain.Entities.Practica", b =>
                {
                    ...
                    b.ToTable("practicas", null, t =>
                        {
                            t.HasCheckConstraint("chk_practicas_empresa_modalidad", "(modalidad = 'Proyecto productivo' AND empresa_id IS NULL) OR (modalidad <> 'Proyecto productivo' AND empresa_id IS NOT NULL)");
